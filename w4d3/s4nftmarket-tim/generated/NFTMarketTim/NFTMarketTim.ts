...
export class NFTMarketTim__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class NFTMarketTim__listingOrdersResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class NFTMarketTim extends ethereum.SmartContract {
  static bind(address: Address): NFTMarketTim {
    return new NFTMarketTim("NFTMarketTim", address);
  }

  eip712Domain(): NFTMarketTim__eip712DomainResult {
    ...
    return new NFTMarketTim__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<NFTMarketTim__eip712DomainResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NFTMarketTim__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  listingOrders(param0: Bytes): NFTMarketTim__listingOrdersResult {
    let result = super.call(
      "listingOrders",
    ...
    return new NFTMarketTim__listingOrdersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_listingOrders(
    param0: Bytes,
  ): ethereum.CallResult<NFTMarketTim__listingOrdersResult> {
    let result = super.tryCall(
      "listingOrders",
      "listingOrders(bytes32):(address,address,uint256,address,uint256,uint256)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NFTMarketTim__listingOrdersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toAddress(),
